...
class Span {
  ...
  public function __construct($vals=null) {
    if (is_array($vals)) {
      ...
      if (isset($vals['incomplete'])) {
        $this->incomplete = $vals['incomplete'];
      }
    }
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 12:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->incomplete);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->incomplete !== null) {
      $xfer += $output->writeFieldBegin('incomplete', TType::BOOL, 12);
      $xfer += $output->writeBool($this->incomplete);
      $xfer += $output->writeFieldEnd();
    }
